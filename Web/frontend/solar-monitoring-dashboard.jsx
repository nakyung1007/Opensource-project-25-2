...
import { Sun, Cloud, Thermometer, Activity, TrendingUp, Calendar, MapPin, Battery, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 p-4">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-900">에너지 모니터링 시스템</h1>
          </div>
          <div className="flex items-center gap-6 text-sm text-gray-600">
            <button className="hover:text-green-600 transition-colors">홈</button>
            <button className="hover:text-green-600 transition-colors">발전소 현황</button>
            <button className="hover:text-green-600 transition-colors">데이터 분석</button>
            <button className="hover:text-green-600 transition-colors">설정</button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="bg-gradient-to-r from-blue-600 to-blue-400 rounded-3xl p-8 relative overflow-hidden">
          <div className="absolute right-0 top-0 w-96 h-96 opacity-10">
            <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath fill='white' d='M12,18L20.39,21.39C22.97,18.59 22.12,14.28 18.75,12.6C18.76,12.4 18.76,12.2 18.75,12C21.33,10.32 22.17,6.5 19.59,3.69L12,7L4.41,3.69C1.83,6.5 2.67,10.32 5.25,12C5.24,12.2 5.24,12.4 5.25,12.6C1.88,14.28 1.03,18.59 3.61,21.39L12,18Z'/%3E%3C/svg%3E" alt="Solar panel" className="w-full h-full" />
          </div>
          <div className="relative z-10">
            <h2 className="text-4xl font-bold text-white mb-4">실시간 태양광 발전 모니터링</h2>
            <p className="text-blue-100 text-lg mb-8">청정 에너지 생산 현황을 실시간으로 확인하고 발전 효율을 최적화하세요</p>
            <div className="flex gap-16">
              <div>
                <p className="text-blue-100 mb-1">현재 발전량</p>
                <p className="text-5xl font-bold text-white">2,847 <span className="text-2xl">kW</span></p>
              </div>
              <div>
                <p className="text-blue-100 mb-1">발전 효율</p>
                <p className="text-5xl font-bold text-white">94.2<span className="text-2xl">%</span></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="px-3 py-1 bg-green-100 text-green-600 rounded-full text-sm font-medium">오늘</span>
          </div>
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={hourlyData}>
              ...
              />
              <Area type="monotone" dataKey="power" stroke="#10b981" strokeWidth={3} fill="url(#colorPower)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-gray-900">일별 발전량 트렌드 (최근 30일)</h3>
